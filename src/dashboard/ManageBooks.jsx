...
const ManageBooks = () => {
  ...
  useEffect( () => {
    fetch("https://bookstore-mernstack-nlu8.onrender.com/all-books").then(res => res.json()).then(data => setAllBooks(data))
  }, [])
 ...
 const handleDelete = (id) =>{
  console.log(id);
  fetch(`https://bookstore-mernstack-nlu8.onrender.com/book/${id}`, {
    method: "DELETE",
  ...
  return (
    <div className='px-4 my-12'>
      ...
      <div class="absolute left-0 top-0 -z-10 h-full w-full rounded-lg bg-white drop-shadow-md dark:bg-black lg:w-[1180px]"></div>
